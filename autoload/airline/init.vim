...
function! airline#init#bootstrap()
  ...
  call airline#parts#define_empty(['hunks', 'branch', 'tagbar', 'syntastic', 'eclim', 'whitespace','windowswap', 'neomake'])
...
function! airline#init#sections()
  ...
  if !exists('g:airline_section_warning')
    let g:airline_section_warning = airline#section#create(['syntastic', 'eclim', 'whitespace', 'neomake'])
  endif
endfunction
